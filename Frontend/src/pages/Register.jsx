    ...
    const handelOnSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                enqueueSnackbar('Welcome to TopNewsNow.',{variant: 'success'})
            }
            else {
            ...
            >
                ...
                >
                    ...
                    <TextField label="Name" variant="filled" fullWidth
                        sx={{ mb: 2 }} onChange={(e) => setName(e.target.value)} value={name} />
                    ...
                    <Button type="submit" sx={{ backgroundColor: "black", color: "white" }} variant="contained">Registor</Button>
